...
def make_row(hit: dict) -> tuple:
    ...
    app = str(src.get("application_key") or APP_KEY).lower()
...
def main():
    ...
    print(f"Importing {APP_KEY} from {ES_INDEX} to PostgreSQL base_event...")
